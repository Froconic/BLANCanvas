exports.ids = [236,101,105,108,110,155,164,166,172];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/events/_slug.vue?vue&type=template&id=6ecdfe9d&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-container"},[_c('HeaderBlack',{on:{"togglenav":function($event){_vm.navOpen = !_vm.navOpen},"toggleSearch":function($event){_vm.searchOpen = !_vm.searchOpen}}}),_vm._ssrNode(" "),_c('OffCanvasMobileMenu',{class:{ 'show-mobile-menu': _vm.navOpen },on:{"togglenav":function($event){_vm.navOpen = !_vm.navOpen}}}),_vm._ssrNode(" "),_c('SearchPopup',{class:{ 'search-popup-open': _vm.searchOpen },on:{"toggleSearch":function($event){_vm.searchOpen = !_vm.searchOpen}}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"brook-portfolio-details bg_color--1\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row pt--100 pt_md--5 pt_sm--5 pb--80\">","</div>",[_vm._ssrNode("<div id=\"is_stuck_inner\" class=\"col-lg-4 col-12 order-2 order-lg-1 mt_md--40 mt_sm--40\">","</div>",[_vm._ssrNode("<div class=\"portfolio-left bk-portfolio-details\">","</div>",[_vm._ssrNode("<div class=\"portfolio-main-info\">","</div>",[_vm._ssrNode("<h3 class=\"heading heading-h3 line-height-1-42\">"+_vm._ssrEscape(_vm._s(_vm.event.title))+"</h3> <div class=\"portfolio-content mt--75 mb--75 mt_md--40 mb_md--40 mt_sm--40 mb_sm--40\"><h6 class=\"heading heading-h6\">ABOUT THE EVENT</h6> <div class=\"desc mt--20\"><p class=\"bk_pra\">"+_vm._ssrEscape(_vm._s(_vm.event.details))+"</p></div></div> "),_vm._ssrNode("<div class=\"portfolio-details-list\">","</div>",[_vm._ssrNode("<div class=\"details-list\"><label>Date</label> <span>"+_vm._ssrEscape(_vm._s(_vm.event.date))+"</span>"+_vm._ssrEscape("\n                  span>"+_vm._s(_vm.event.time))+"</div> <div class=\"details-list\"><label>Location</label> <span>"+_vm._ssrEscape(_vm._s(_vm.event.location))+"</span></div> "),_vm._ssrNode("<div class=\"details-list\">","</div>",[_vm._ssrNode("<label>Category</label> "),_vm._ssrNode("<span>","</span>",[_c('n-link',{attrs:{"to":"/"}},[_vm._v("\n                      "+_vm._s(_vm.event.category)+"\n                    ")])],1)],2)],2)],2)])]),_vm._ssrNode(" <div class=\"col-lg-8 col-12 order-1 order-lg-2\"><div class=\"portfolio-right portfolio-details-gallery text-center text-lg-right\"><div class=\"portfolio-image mb--50\"><img"+(_vm._ssrAttr("src",_vm.event.cover))+" alt=\"portfolio\"></div></div></div>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-12\">","</div>",[_vm._ssrNode("<div class=\"portfolio-nav-list pt--50 pb--150 pb_md--80 pb_sm--60 pt_md--5 pt_sm--5\">","</div>",[_vm._ssrNode("<div class=\"portfolio-page prev\">","</div>",[_vm._ssrNode("<div class=\"inner\">","</div>",[_c('n-link',{attrs:{"to":"/portfolio/portfolio-grid-wide"}},[_c('p',[_vm._v("Prev")]),_vm._v(" "),_c('h3',{staticClass:"heading heading-h3"},[_vm._v("Awe-inspiring "),_c('br'),_vm._v(" Projects")])])],1)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"portfolio-page next mt_sm--30\">","</div>",[_vm._ssrNode("<div class=\"inner\">","</div>",[_c('n-link',{attrs:{"to":"/portfolio/portfolio-grid-wide"}},[_c('p',[_vm._v("Next")]),_vm._v(" "),_c('h3',{staticClass:"heading heading-h3"},[_vm._v("B-sharp High-end "),_c('br'),_vm._v(" Audio")])])],1)])],2)])])])],2),_vm._ssrNode(" "),_c('FooterTwo')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/events/_slug.vue?vue&type=template&id=6ecdfe9d&

// CONCATENATED MODULE: ./utils/getEvents.js
/* harmony default export */ var getEvents = (async ($content, params, error) => {
  const currentPage = parseInt(params.page);
  const perPage = 6;
  const allEvents = await $content("events").fetch();
  const totalEvents = allEvents.length; // use Math.ceil to round up to the nearest whole number

  const lastPage = Math.ceil(totalEvents / perPage); // use the % (modulus) operator to get a whole remainder
  ...
  const paginatedEvents = await $content("events").only(["title", "description", "cover", "slug", "location", "time", "date", "details", "category"]).sortBy("order", "desc").limit(perPage).skip(skipNumber()).fetch();
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/events/_slug.vue?vue&type=script&lang=js&
//
//
//
//
