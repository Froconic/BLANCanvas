exports.ids = [206,43,64,101,105,108,110,139,155,164,166,172];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-grid-minimal.vue?vue&type=template&id=04b7beed&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-container"},[_c('HeaderBlack',{attrs:{"addClass":"header-transparent"},on:{"togglenav":function($event){_vm.navOpen = !_vm.navOpen},"toggleSearch":function($event){_vm.searchOpen = !_vm.searchOpen}}}),_vm._ssrNode(" "),_c('OffCanvasMobileMenu',{class:{'show-mobile-menu' : _vm.navOpen},on:{"togglenav":function($event){_vm.navOpen = !_vm.navOpen}}}),_vm._ssrNode(" "),_c('SearchPopup',{class:{'search-popup-open' : _vm.searchOpen},on:{"toggleSearch":function($event){_vm.searchOpen = !_vm.searchOpen}}}),_vm._ssrNode(" <div class=\"breadcrumb-area pt--260 pb--80 pt_md--200 pt_sm--150 bg_color--5 breadcrumb-title-bar\"><div class=\"container\"><div class=\"row\"><div class=\"col-lg-12\"><div class=\"breadcrumb-inner text-center\"><h1 class=\"heading heading-h1\">Creative List</h1></div></div></div></div></div> "),_vm._ssrNode("<div class=\"blog-creative-area bg_color--5 pt--70 pb--100\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-8 mtn--60\">","</div>",[_vm._ssrNode("<div class=\"row row--30\">","</div>",_vm._l((_vm.data.blogs.slice(3, 15)),function(blog){return _vm._ssrNode("<div class=\"col-sm-6 move-up wow mt--60\">","</div>",[_vm._ssrNode("<div class=\"blog-grid-minimal\">","</div>",[_vm._ssrNode("<div class=\"grid-overlay\""+(_vm._ssrStyle(null,{ backgroundImage: ("url(" + (blog.image) + ")") }, null))+"></div> "),_vm._ssrNode("<div class=\"post-content\">","</div>",[_vm._ssrNode("<h5 class=\"heading\">","</h5>",[_c('n-link',{attrs:{"to":("/blog/" + (blog.slug))}},[_vm._v("\n                                            "+_vm._s(blog.title)+"\n                                        ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"post-meta\">","</div>",[_vm._ssrNode("<div class=\"post-date\">"+_vm._ssrEscape(_vm._s(blog.date))+"</div> "),_vm._ssrNode("<div class=\"post-category\">","</div>",_vm._l((blog.categories.slice(0, 1)),function(category,i){return _c('n-link',{key:i,attrs:{"to":("/blog/category/" + (_vm.slugify(category)))}},[_vm._v(_vm._s(category))])}),1)],2)],2)],2)])}),0),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"brook-pagination-wrapper text-center pt--80\">","</div>",[_c('paginate',{attrs:{"page-count":4,"page-range":3,"margin-pages":2,"prev-text":'Prev',"next-text":'Next',"container-class":'brook-pagination',"page-class":'page-item'}})],1)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-4 mt_md--40 mt_sm--40\">","</div>",[_c('BlogSidebar')],1)],2)])]),_vm._ssrNode(" "),_c('FooterTwo')],2)}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-grid-minimal.vue?vue&type=script&lang=js&
//
//
//
//
