exports.ids = [201,43,64,101,105,108,110,139,155,164,166,172];
exports.modules = {
...
/* harmony default export */ var blog_detailsvue_type_script_lang_js_ = ({
  ...
  mounted() {
    this.data = blog.blogs.find(blog => blog.id == this.$route.params.id);
