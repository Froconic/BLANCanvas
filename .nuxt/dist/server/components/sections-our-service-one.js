...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ServiceItemStyleTwo.vue?vue&type=template&id=339ab0b3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"icon-box text-center no-border with-padding mt--40"},[_vm._ssrNode("<div class=\"inner\">","</div>",[_vm._ssrNode("<div class=\"icon\"><img"+(_vm._ssrAttr("src",_vm.service.icon))+(_vm._ssrAttr("alt",_vm.service.heading))+"></div> "),_vm._ssrNode("<div class=\"content\">","</div>",[_vm._ssrNode("<h5 class=\"heading heading-h5\">"+_vm._ssrEscape(_vm._s(_vm.service.heading))+"</h5> <p class=\"bk_pra\">"+_vm._ssrEscape(_vm._s(_vm.service.desc))+"</p> "),_c('n-link',{staticClass:"icon-btn color-red",attrs:{"to":"/services-classic"}},[_c('span',[_vm._v("More details")]),_vm._v(" "),_c('i',{staticClass:"fa fa-arrow-right"})])],2)],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/ServiceItemStyleTwo.vue?vue&type=template&id=339ab0b3&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sections/OurServiceOne.vue?vue&type=template&id=bdc83c00&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"brook-icon-boxes-area ptb--120 ptb-md--80 ptb-sm--80 bg_image--17",style:({ backgroundImage: "url('/img/bg/bg-image-17.jpg')" }),attrs:{"id":"section-our-services"}},[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\"><div class=\"col-lg-12\"><div class=\"brook-section-title text-center\"><h3 class=\"heading heading-h3 font-large\">Best services save the world</h3> <div class=\"bkseparator--25\"></div> <div class=\"title-separator w--80 color-red\"></div></div></div></div> "),_vm._ssrNode("<div class=\"row mt--40\">","</div>",[_vm._l((_vm.data.services.slice(9, 12)),function(service){return _vm._ssrNode("<div class=\"col-lg-4 col-sm-6 wow move-up\">","</div>",[_c('ServiceItemStyleTwo',{attrs:{"service":service}})],1)}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-12\">","</div>",[_vm._ssrNode("<div class=\"best-service-footer plr--160 plr_md--50 plr_sm--20 plr_lg--50 text-center mt--70\">","</div>",[_vm._ssrNode("<h6 class=\"heading heading-h6 font-16 line-height-1-88 font-medium body-color\">Since its establishment in 2000, Brook Creative has been focusing on project management &amp; implementation through global cooperation &amp; partners.</h6> <div class=\"bkseparator--45\"></div> "),_vm._ssrNode("<div class=\"brook-btn\">","</div>",[_c('n-link',{staticClass:"brook-btn bk-btn-red btn-sd-size btn-rounded space-between",attrs:{"to":"/contact-us-modern"}},[_vm._v("Learn More")])],1)],2)])],2)],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/sections/OurServiceOne.vue?vue&type=template&id=bdc83c00&

// EXTERNAL MODULE: ./data/service.json
var service = __webpack_require__(91);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sections/OurServiceOne.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var OurServiceOnevue_type_script_lang_js_ = ({
  components: {
    ServiceItemStyleTwo: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 304))
  },
...
// CONCATENATED MODULE: ./components/sections/OurServiceOne.vue?vue&type=script&lang=js&
 /* harmony default export */ var sections_OurServiceOnevue_type_script_lang_js_ = (OurServiceOnevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/sections/OurServiceOne.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  sections_OurServiceOnevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var OurServiceOne = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {ServiceItemStyleTwo: __webpack_require__(304).default})
...
//# sourceMappingURL=sections-our-service-one.js.map